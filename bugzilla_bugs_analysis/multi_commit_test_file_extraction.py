...
"""
================================================================================
EXTRACT TEST FILES FROM FIXING COMMITS
================================================================================
...
class testExtractorPipeline:
    ...
    def __init__(self):
        ...
        self.output_base = self.outputs_base / "multi_fixing_commit_tests"
    ...
    def load_bug_dirs(self) -> List[Path]:
        ...
        if not base.exists():
            print(f"ERROR: {base} not found — run input step first.")
            return []
    ...
    def _print_summary(self, s: Dict):
        ...
        print("\n" + "=" * 80)
        print("TEST_FILE_EXTRACTION SUMMARY")
        print("=" * 80)
    ...
    def _save_summary(self, stats: Dict, results: Dict):
        ...
        lines = [
            "=" * 80, "TEST_EXTRACTION STATISTICS REPORT", "=" * 80,
